...
#SBATCH --job-name=Global_shiemom_realIC
#SBATCH --clusters=c6
...
set RELEASE = "SHiEMOM/GLOBAL_ocean_test/"
...
set MEMO = "res$res.ocean_glorys_ic_1day"
...
###########################################################################
  ...
  ln -sf $MOM_INPUT_DIR/INPUT/tidal_amplitude.v20140616.nc INPUT/
  ln -sf $MOM_INPUT_DIR/INPUT/ocean_topog.nc INPUT/
  ln -sf $MOM_INPUT_DIR/INPUT/topog.nc INPUT/
  ln -sf $MOM_INPUT_DIR/INPUT/seawifs-clim-1997-2010.1440x1080.v20180328.nc INPUT/
...
#override TEMP_Z_INIT_FILE = "glo12_rg_6h-i_20240926-00h_3D-thetao_hcst_R20241009.nc" 
#override SALT_Z_INIT_FILE = "glo12_rg_6h-i_20240926-00h_3D-so_hcst_R20241009.nc"
#override Z_INIT_FILE_PTEMP_VAR = "thetao" ! default = "ptemp"
#override Z_INIT_FILE_SALT_VAR = "so"   ! default = "salt"
...
#override SURFACE_HEIGHT_IC_FILE = "glorys_ic_OM4_025_fill_at_the_end.nc"
#override SURFACE_HEIGHT_IC_VAR = "ssh"
#override VELOCITY_CONFIG = "file"
#override VELOCITY_FILE = "glorys_ic_OM4_025_fill_at_the_end.nc"
